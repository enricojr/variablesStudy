...
PDPath = '/nfs/kloe/einstein2/enricojr/data/2019-10-17/PandaDataFrames_resolved_vbf/'

mixedFileName = 'MixPD_ResolvedGGFH'
mode = 'binary'

if doConvertToPD:
    commands += ['python RunML.py --ConvertRootToPD --InputMLNtuplePath '+InPath+' --inROOTFiles '+bkgFiles+ ',Data,'+signalFiles+' --PreselectionCommand "inPanda[(inPanda.Pass_Res_VBF_ZZSR==1) | (inPanda.Pass_ResT_VBF_ZZSR==1) | (inPanda.Pass_Res_VBF_ZZZCR==1) | (inPanda.Pass_ResT_VBF_ZZZCR==1)]" --PDPath '+PDPath ]
